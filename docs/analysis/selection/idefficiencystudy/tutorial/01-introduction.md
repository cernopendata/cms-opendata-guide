...
The **tag and probe** method is a **data-driven technique** for measuring particle detection efficiencies. It is based on the decays of known resonances (e.g. J/&psi;, &Upsilon; and Z) to pairs of the particles being studied. In this exercise, these particles are muons, and the J/&psi; resonance is nominally used.
...
The tag+probe invariant mass distribution is used to select only signal, that is, only true J/&psi; candidates decaying to dimuons. This is achieved in this exercise by the usage of two methods: **fitting** and **side-band-subtraction**.
